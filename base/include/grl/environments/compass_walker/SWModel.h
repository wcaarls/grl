...
{
	protected:
		uint64_t		mTime;	// Time in microseconds since the creation of the model
	...
	public:
		...
		// Provide steptime parameter in seconds. It will be converted to microseconds internally.
