/** \file dmp.h
 * \brief Dynamic movement primitive representation header file.
 *
...
#ifndef GRL_DMP_REPRESENTATION_H_
#define GRL_DMP_REPRESENTATION_H_
...
#endif /* GRL_DMP_REPRESENTATION_H_ */
