...
#ifndef GRL_MHE_NMPC_SW_H_
#define GRL_MHE_NMPC_SW_H_
...
class MHE_NMPC_SWPolicy : public Policy
{
  ...
  public:
    MHE_NMPC_SWPolicy() : muscod_mhe_(NULL), muscod_nmpc_(NULL), outputs_(1), verbose_(false) { }
    ~MHE_NMPC_SWPolicy();
