...
// *****************************************************************************
  ...
  extern const unsigned int LSQFCN_FITTING_NE;
  extern const unsigned int LSQFCN_FITTING_REG_NE;
  ...
  // measurement horizon
  // extern Eigen::VectorXd m_ts; // measurement times
  extern Eigen::MatrixXd meas_hs; // measurements
  extern Eigen::MatrixXd meas_ss; // measurement errors
...
// *****************************************************************************
  ...
  extern "C" {
    ...
    extern void print_horizon();

    extern Eigen::MatrixXd* get_measurements();
    extern Eigen::MatrixXd* get_sigmas();
  }
...
// *****************************************************************************
 ...
 void lsqfcn_fitting(
    double *ts, double *sd, double *sa, double *u, double *p,
