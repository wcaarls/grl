...
if normalization:
  ...
  han = ha
a_out = Dense(actions, activation='tanh', kernel_initializer=RandomUniform(minval=-0.003, maxval=0.003), name='a_out')(han)
...
if normalization:
  ...
  hqn = hq
q = Dense(1, activation='linear', kernel_initializer=RandomUniform(minval=-0.003, maxval=0.003), name='q')(hqn)
